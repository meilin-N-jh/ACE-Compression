...
import os
os.environ["CUDA_VISIBLE_DEVICES"] = "6"  # 使用第6张卡
import sys

# ==================== 配置 ====================
SOURCE_MODEL = f"{ARTIFACT_ROOT}/models/Qwen2.5-32B/Qwen2.5-32B-Instruct"
OUTPUT_MODEL = f"{ARTIFACT_ROOT}/models/Qwen2.5-32B/Qwen2.5-32B-2to4-Sparse"
...
print("=" * 60)
print("2:4 半结构化稀疏剪枝 - Qwen2.5-32B")
print("=" * 60)
...
print(f"\n✓ 剪枝完成: {OUTPUT_MODEL}")
print(f"下一步: bash {ARTIFACT_ROOT}/models/Qwen2.5-32B/start_vllm_sparse.sh")
