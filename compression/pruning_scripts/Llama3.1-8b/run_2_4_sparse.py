...
OUTPUT_MODEL = f"{ARTIFACT_ROOT}/models/llama3.1-8b/Meta-Llama-3.1-8B-Instruct-2to4-Sparse"
...
print("=" * 60)
print("2:4 半结构化稀疏剪枝 - Llama3.1-8b")
print("=" * 60)
...
print(f"\n✓ 剪枝完成: {OUTPUT_MODEL}")
print(f"下一步: bash {ARTIFACT_ROOT}/models/llama3.1-8b/start_vllm_sparse.sh")
