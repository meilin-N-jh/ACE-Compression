#!/usr/bin/env python3
"""
无结构化稀疏剪枝脚本 - DeepSeek-V2-Lite-Chat-16B
...
OUTPUT_MODEL = f"{ARTIFACT_ROOT}/models/DeepSeek-V2-Lite-Chat-16B/DeepSeek-V2-Lite-Chat-Unstructured-Sparse-50"
...
print("=" * 60)
print("无结构化稀疏剪枝 - DeepSeek-V2-Lite (16B) (50%)")
print("=" * 60)
...
print(f"\n✓ 剪枝完成: {OUTPUT_MODEL}")
print(f"下一步: bash {ARTIFACT_ROOT}/models/DeepSeek-V2-Lite-Chat-16B/start_vllm_unstructured.sh")
