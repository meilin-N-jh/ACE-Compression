#!/usr/bin/env python3
"""
无结构化稀疏剪枝脚本 - Llama3-70b
使用 llmcompressor 进行无结构化稀疏剪枝
...
OUTPUT_MODEL = f"{ARTIFACT_ROOT}/models/Llama3-70b/Llama-3.1-70B-Instruct-Unstructured-Sparse-50"
