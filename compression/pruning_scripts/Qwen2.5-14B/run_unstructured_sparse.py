...
# ==================== 配置 ====================
SOURCE_MODEL = f"{ARTIFACT_ROOT}/models/Qwen2.5-14B/Qwen2.5-14B-Instruct-FP16"
OUTPUT_MODEL = f"{ARTIFACT_ROOT}/models/Qwen2.5-14B/Qwen2.5-14B-Unstructured-Sparse-50"
...
print(f"\n✓ 剪枝完成: {OUTPUT_MODEL}")
print(f"下一步: bash {ARTIFACT_ROOT}/models/Qwen2.5-14B/start_vllm_unstructured.sh")
