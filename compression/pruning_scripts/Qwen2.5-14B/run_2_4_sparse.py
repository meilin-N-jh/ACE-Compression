...
OUTPUT_MODEL = f"{ARTIFACT_ROOT}/models/Qwen2.5-14B/Qwen2.5-14B-2to4-Sparse"
...
print("=" * 60)
print("2:4 半结构化稀疏剪枝 - Qwen2.5-14B")
print("=" * 60)
...
print(f"\n✓ 剪枝完成: {OUTPUT_MODEL}")
print(f"下一步: bash {ARTIFACT_ROOT}/models/Qwen2.5-14B/start_vllm_sparse.sh")
