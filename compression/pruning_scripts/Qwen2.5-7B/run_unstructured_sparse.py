...
OUTPUT_MODEL = f"{ARTIFACT_ROOT}/models/Qwen2.5-7B/Qwen2.5-7B-Instruct-Unstructured-Sparse-50"
...
print(f"\n✓ 剪枝完成: {OUTPUT_MODEL}")
print(f"下一步: bash {ARTIFACT_ROOT}/models/Qwen2.5-7B/start_vllm_unstructured.sh")
