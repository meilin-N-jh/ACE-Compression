#!/usr/bin/env python3
"""ToM-Bench evaluation for Qwen2.5-14B variants using vLLM backend.
Adapted from official ToM-Bench + llama70B implementation.
"""
...
def default_results_dir(language: str) -> Path:
    ...
    return TOMBENCH_ROOT / "qwen2.5-14b" / subdir
