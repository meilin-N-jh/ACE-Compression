...
RESULTS_DIR = Path(f'{ARTIFACT_ROOT}/paper_benchmarks/07_ToM-Bench/benchmark/deepseek-v2-lite-16b/results')
...
print(f"\nAll tasks found: {all_tasks}")
print(f"All abilities found: {all_abilities}")

# Generate Task CSV with CI
task_csv = f'{ARTIFACT_ROOT}/paper_benchmarks/07_ToM-Bench/benchmark/deepseek-v2-lite-16b/tombench_task_summary_with_ci.csv'
...
ability_csv = f'{ARTIFACT_ROOT}/paper_benchmarks/07_ToM-Bench/benchmark/deepseek-v2-lite-16b/tombench_ability_summary_with_ci.csv'
