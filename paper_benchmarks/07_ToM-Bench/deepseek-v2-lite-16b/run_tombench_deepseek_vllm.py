#!/usr/bin/env python3
"""ToM-Bench evaluation for DeepSeek-V2-Lite-16B variants using vLLM backend.
Adapted from qwen2.5-14b implementation.
"""
...
def default_results_dir(language: str) -> Path:
    ...
    return TOMBENCH_ROOT / "deepseek-v2-lite-16b" / subdir
