...
# Run PsychoBench for Qwen2.5-32B Unstructured Sparse via vLLM OpenAI API
...
PORT="8209"
MODEL_NAME="qwen2.5-32b-unstructured-sparse"
RUN_NAME="Qwen2.5-32B-Unstructured-Sparse"
...
if ! curl -s "http://127.0.0.1:${PORT}/v1/models" > /dev/null 2>&1; then
  ...
  echo "  bash ${ARTIFACT_ROOT}/models/Qwen2.5-32B/start_vllm_unstructured_sparse.sh"
  exit 1
fi
