#!/usr/bin/env python3
"""
Run PsychoBench with Qwen2.5-32B via vLLM API
用法: python run_psychobench_qwen25_32b.py --base-url http://127.0.0.1:8200/v1 --model qwen2.5-32b-fp16 --questionnaire Empathy,BFI,BSRI --shuffle-count 1 --test-count 10
"""
...
from qwen25_32b_vllm_generator import qwen25_32b_vllm_generator


def main():
    parser = argparse.ArgumentParser(description="Run PsychoBench with Qwen2.5-32B via vLLM API")

    # 模型配置
    parser.add_argument('--base-url', required=True, type=str,
                       help='vLLM API base URL (e.g., http://127.0.0.1:8200/v1)')
    parser.add_argument('--model', required=True, type=str,
                       help='Model name (e.g., qwen2.5-32b-fp16)')
    ...
    print("=" * 60)
    print("PsychoBench: Qwen2.5-32B via vLLM API")
    print("=" * 60)
    ...
    # 运行评测
    run_psychobench(args, qwen25_32b_vllm_generator)
