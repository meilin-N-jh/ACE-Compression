...
# Run PsychoBench for Qwen2.5-7B Unstructured Sparse via vLLM OpenAI API
...
PORT="8405"
MODEL_NAME="qwen2.5-7b-unstructured-sparse"
RUN_NAME="Qwen2.5-7B-Unstructured-Sparse"
