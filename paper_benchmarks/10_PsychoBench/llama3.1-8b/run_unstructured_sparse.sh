...
# Run PsychoBench for Llama3.1-8B Unstructured Sparse via vLLM OpenAI API
...
PORT="8411"
MODEL_NAME="meta-llama-3.1-8b-instruct-unstructured-sparse"
RUN_NAME="Llama3.1-8B-Unstructured-Sparse"
...
if ! curl -s "http://127.0.0.1:${PORT}/v1/models" > /dev/null 2>&1; then
  ...
  echo "  bash ${ARTIFACT_ROOT}/models/Llama3.1-8b/start_vllm_unstructured_sparse.sh"
  exit 1
fi
