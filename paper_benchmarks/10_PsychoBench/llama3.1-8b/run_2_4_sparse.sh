...
# Run PsychoBench for Llama3.1-8B 2:4 Sparse via vLLM OpenAI API
...
PORT="8410"
MODEL_NAME="meta-llama-3.1-8b-instruct-2to4-sparse"
RUN_NAME="Llama3.1-8B-2:4-Sparse"
...
if ! curl -s "http://127.0.0.1:${PORT}/v1/models" > /dev/null 2>&1; then
  ...
  echo "  bash ${ARTIFACT_ROOT}/models/Llama3.1-8b/start_vllm_2_4_sparse.sh"
  exit 1
fi
