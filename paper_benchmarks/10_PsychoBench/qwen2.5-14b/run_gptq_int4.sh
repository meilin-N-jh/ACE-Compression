...
# Run PsychoBench for Qwen2.5-14B GPTQ INT4 via vLLM OpenAI API
...
PORT="8103"
MODEL_NAME="qwen2.5-14b-gptq-int4"
RUN_NAME="Qwen2.5-14B-GPTQ-INT4"
...
if ! curl -s "http://127.0.0.1:${PORT}/v1/models" > /dev/null 2>&1; then
  ...
  echo "  bash ${ARTIFACT_ROOT}/models/Qwen2.5-14B/start_vllm_gptq_int4.sh"
  exit 1
fi
