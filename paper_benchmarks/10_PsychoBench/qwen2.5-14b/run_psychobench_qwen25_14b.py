#!/usr/bin/env python3
"""
Run PsychoBench with Qwen2.5-14B via vLLM API
用法: python run_psychobench_qwen25_14b.py --base-url http://127.0.0.1:8100/v1 --model qwen2.5-14b-fp16 --questionnaire Empathy,BFI,BSRI --shuffle-count 1 --test-count 10
"""
...
from qwen25_14b_vllm_generator import qwen25_14b_vllm_generator
