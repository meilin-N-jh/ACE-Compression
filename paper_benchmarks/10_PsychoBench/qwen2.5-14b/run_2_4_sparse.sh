...
# Run PsychoBench for Qwen2.5-14B 2:4 Sparse via vLLM OpenAI API
...
PORT="8105"
MODEL_NAME="qwen2.5-14b-2to4-sparse"
RUN_NAME="Qwen2.5-14B-2:4-Sparse"
...
if ! curl -s "http://127.0.0.1:${PORT}/v1/models" > /dev/null 2>&1; then
  ...
  echo "  bash ${ARTIFACT_ROOT}/models/Qwen2.5-14B/start_vllm_2_4_sparse.sh"
  exit 1
fi
