...
# Run PsychoBench for Qwen2.5-14B AWQ via vLLM OpenAI API
...
PORT="8102"
MODEL_NAME="qwen2.5-14b-awq"
RUN_NAME="Qwen2.5-14B-AWQ"
...
if ! curl -s "http://127.0.0.1:${PORT}/v1/models" > /dev/null 2>&1; then
  ...
  echo "  bash ${ARTIFACT_ROOT}/models/Qwen2.5-14B/start_vllm_awq.sh"
  exit 1
fi
