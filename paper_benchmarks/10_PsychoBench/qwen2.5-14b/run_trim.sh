...
# Run PsychoBench for Qwen2.5-14B Trim via vLLM OpenAI API
...
PORT="8104"
MODEL_NAME="qwen2.5-14b-trim"
RUN_NAME="Qwen2.5-14B-Trim"
...
RUN_LOG="$LOG_DIR/psychobench_trim_${TIMESTAMP}.log"
...
if ! curl -s "http://127.0.0.1:${PORT}/v1/models" > /dev/null 2>&1; then
  ...
  echo "  bash ${ARTIFACT_ROOT}/models/Qwen2.5-14B/start_vllm_trim.sh"
  exit 1
fi
