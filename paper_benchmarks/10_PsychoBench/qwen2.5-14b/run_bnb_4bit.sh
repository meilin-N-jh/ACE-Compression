...
# Run PsychoBench for Qwen2.5-14B BNB 4bit via vLLM OpenAI API
...
PORT="8101"
MODEL_NAME="qwen2.5-14b-bnb-4bit"
RUN_NAME="Qwen2.5-14B-BNB-4bit"
...
RUN_LOG="$LOG_DIR/psychobench_bnb4bit_${TIMESTAMP}.log"
...
if ! curl -s "http://127.0.0.1:${PORT}/v1/models" > /dev/null 2>&1; then
  ...
  echo "  bash ${ARTIFACT_ROOT}/models/Qwen2.5-14B/start_vllm_bnb_4bit.sh"
  exit 1
fi
