#!/usr/bin/env python3
"""
Run PsychoBench with Llama70B via vLLM API
...
from llama70b_vllm_generator import llama70b_vllm_generator


def main():
    parser = argparse.ArgumentParser(description="Run PsychoBench with Llama70B via vLLM API")
    ...
    print("=" * 60)
    print("PsychoBench: Llama70B via vLLM API")
    print("=" * 60)
    ...
    # 运行评测
    run_psychobench(args, llama70b_vllm_generator)
