...
# Run PsychoBench for Llama70B GPTQ INT8 via vLLM OpenAI API
...
PORT="8003"
MODEL_NAME="llama31-70b-gptq-int8"
RUN_NAME="Llama-70B-GPTQ-INT8"
...
RUN_LOG="$LOG_DIR/psychobench_gptq_int8_${TIMESTAMP}.log"
...
if ! curl -s "http://127.0.0.1:${PORT}/v1/models" > /dev/null 2>&1; then
  ...
  echo "  bash ${ARTIFACT_ROOT}/models/Llama3-70b/start_vllm_gptq_int8.sh"
  exit 1
fi
