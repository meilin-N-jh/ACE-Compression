...
# Run PsychoBench for Llama70B Unstructured Sparse via vLLM OpenAI API
...
PORT="8011"
MODEL_NAME="llama31-70b-unstructured-sparse"
RUN_NAME="Llama70B-Unstructured-Sparse"
...
if ! curl -s "http://127.0.0.1:${PORT}/v1/models" > /dev/null 2>&1; then
  ...
  echo "  bash ${ARTIFACT_ROOT}/models/Llama3-70b/start_vllm_unstructured_sparse.sh"
  exit 1
fi
