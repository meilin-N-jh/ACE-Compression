...
# Run PsychoBench for Llama70B BNB 4bit via vLLM OpenAI API
...
PORT="8002"
MODEL_NAME="llama31-70b-bnb4bit"
RUN_NAME="Llama-70B-4bit"
...
if ! curl -s "http://127.0.0.1:${PORT}/v1/models" > /dev/null 2>&1; then
  ...
  echo "  bash ${ARTIFACT_ROOT}/models/Llama3-70b/start_vllm_4bit.sh"
  exit 1
fi
