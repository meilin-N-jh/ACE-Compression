...
# Run PsychoBench for Llama70B GPTQ INT4 via vLLM OpenAI API
...
PORT="8004"
MODEL_NAME="llama31-70b-gptq-int4"
RUN_NAME="Llama-70B-GPTQ-INT4"
...
if ! curl -s "http://127.0.0.1:${PORT}/v1/models" > /dev/null 2>&1; then
  ...
  echo "  bash ${ARTIFACT_ROOT}/models/Llama3-70b/start_vllm_gptq_int4.sh"
  exit 1
fi
