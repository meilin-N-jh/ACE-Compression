...
# Run PsychoBench for DeepSeek-V2-Lite-16B AWQ via vLLM OpenAI API
# 需要先手动启动vLLM服务器
...
PORT="8302"
MODEL_NAME="deepseek-v2-lite-awq"
RUN_NAME="DeepSeek-V2-Lite-16B-AWQ"
...
RUN_LOG="$LOG_DIR/psychobench_awq_${TIMESTAMP}.log"
...
if ! curl -s "http://127.0.0.1:${PORT}/v1/models" > /dev/null 2>&1; then
  ...
  echo "  bash ${ARTIFACT_ROOT}/models/DeepSeek-V2-Lite-Chat-16B/start_vllm_awq.sh"
  exit 1
fi
