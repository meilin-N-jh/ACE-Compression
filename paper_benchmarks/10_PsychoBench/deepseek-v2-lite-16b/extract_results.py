#!/usr/bin/env python3
"""
Extract PsychoBench results from .md files and generate pivot CSV for DeepSeek-V2-Lite-16B
"""
...
MODELS = ['DeepSeek-V2-Lite-16B-FP16', 'DeepSeek-V2-Lite-16B-BNB-4bit', 'DeepSeek-V2-Lite-16B-AWQ',
          'DeepSeek-V2-Lite-16B-2:4-Sparse', 'DeepSeek-V2-Lite-16B-Unstructured-Sparse']
...
# 生成 CSV
output_file = Path(f'{ARTIFACT_ROOT}/paper_benchmarks/10_PsychoBench/benchmark/deepseek-v2-lite-16b/psychobench_results_pivot.csv')
