...
# Run PsychoBench for DeepSeek-V2-Lite-16B BNB-4bit via vLLM OpenAI API
...
PORT="8301"
MODEL_NAME="deepseek-v2-lite-bnb-4bit"
RUN_NAME="DeepSeek-V2-Lite-16B-BNB-4bit"
...
RUN_LOG="$LOG_DIR/psychobench_bnb_4bit_${TIMESTAMP}.log"
...
if ! curl -s "http://127.0.0.1:${PORT}/v1/models" > /dev/null 2>&1; then
  ...
  echo "  bash ${ARTIFACT_ROOT}/models/DeepSeek-V2-Lite-Chat-16B/start_vllm_bnb_4bit.sh"
  exit 1
fi
