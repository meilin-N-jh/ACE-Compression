...
# Run PsychoBench for DeepSeek-V2-Lite-16B 2:4 Sparse via vLLM OpenAI API
...
PORT="8304"
MODEL_NAME="deepseek-v2-lite-2to4-sparse"
RUN_NAME="DeepSeek-V2-Lite-16B-2:4-Sparse"
...
if ! curl -s "http://127.0.0.1:${PORT}/v1/models" > /dev/null 2>&1; then
  ...
  echo "  bash ${ARTIFACT_ROOT}/models/DeepSeek-V2-Lite-Chat-16B/start_vllm_2_4_sparse.sh"
  exit 1
fi
