...
#
# model_key 选项:
#   - qwen25_32b_fp16_vllm
#   - qwen25_32b_bnb_4bit_vllm
#   - qwen25_32b_awq_vllm
#   - qwen25_32b_gptq_int4_vllm
#   - qwen25_32b_trim_vllm

MODEL_KEY=${1:-"qwen25_32b_fp16_vllm"}
...
python run_roleeval_qwen25_32b.py \
    --model "$MODEL_KEY" \
    --lang both \
    --subset both \
    --split test
