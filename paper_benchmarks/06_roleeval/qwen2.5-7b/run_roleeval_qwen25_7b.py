#!/usr/bin/env python3
"""RoleEval bilingual evaluation for Qwen2.5-14B variants (zh + en, chinese + global)."""
import os
import sys
import argparse
...
def main():
    parser = argparse.ArgumentParser(description="RoleEval bilingual evaluation for Qwen2.5-14B")
