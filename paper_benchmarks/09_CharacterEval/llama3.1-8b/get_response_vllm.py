#!/usr/bin/env python3
"""CharacterEval response generation using vLLM backend for Llama3.1-8B variants.
Adapted from official CharacterEval + qwen2.5-14b implementation.
"""
import sys
import argparse
import json
...
RESULTS_BASE_DIR = CHARACTEREVAL_ROOT / "llama3.1-8b" / "results"
...
def main():
    parser = argparse.ArgumentParser(description='CharacterEval evaluation for Llama3.1-8B using vLLM backend')
    parser.add_argument('--model-display-name', type=str, required=True,
                        help='Model display name (e.g., "Llama3.1-8B-FP16")')
    parser.add_argument('--base-url', type=str, required=True,
                        help='vLLM base URL (e.g., "http://127.0.0.1:8400")')
    parser.add_argument('--model-name', type=str, required=True,
                        help='Model name for vLLM API (e.g., "meta-llama-3.1-8b-instruct-fp16")')
