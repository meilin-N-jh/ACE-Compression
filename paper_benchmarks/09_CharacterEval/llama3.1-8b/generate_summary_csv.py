#!/usr/bin/env python3
"""Generate official-aligned CharacterEval summary CSV for llama3.1-8b."""
...
results_dir = CHARACTEREVAL_ROOT / "llama3.1-8b" / "results"
output_file = CHARACTEREVAL_ROOT / "llama3.1-8b" / "charactereval_results_summary.csv"
