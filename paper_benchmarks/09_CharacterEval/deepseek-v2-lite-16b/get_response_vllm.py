#!/usr/bin/env python3
"""CharacterEval response generation using vLLM backend for Qwen2.5-14B variants.
...
RESULTS_BASE_DIR = CHARACTEREVAL_ROOT / "deepseek-v2-lite-16b" / "results"
...
def main():
    parser = argparse.ArgumentParser(description='CharacterEval evaluation for Qwen2.5-14B using vLLM backend')
    parser.add_argument('--model-display-name', type=str, required=True,
                        help='Model display name (e.g., "Qwen2.5-14B-FP16")')
    parser.add_argument('--base-url', type=str, required=True,
                        help='vLLM base URL (e.g., "http://127.0.0.1:8100")')
    parser.add_argument('--model-name', type=str, required=True,
                        help='Model name for vLLM API (e.g., "qwen2.5-14b-fp16")')
