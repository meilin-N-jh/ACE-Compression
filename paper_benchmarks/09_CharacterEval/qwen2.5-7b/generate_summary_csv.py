#!/usr/bin/env python3
"""Generate official-aligned CharacterEval summary CSV for qwen2.5-7b."""
...
results_dir = CHARACTEREVAL_ROOT / "qwen2.5-7b" / "results"
output_file = CHARACTEREVAL_ROOT / "qwen2.5-7b" / "charactereval_results_summary.csv"
