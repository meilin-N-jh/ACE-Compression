#!/usr/bin/env python3
"""Run CharacterRM evaluation (adapted from official for qwen2.5-14b)."""
import sys
import argparse
import json
import torch
...
def main():
    ...
    parser.add_argument('--display-name', type=str, default=None,
                        help='Display name for results directory (e.g., "Qwen2.5-14B-FP16")')
    ...
    model_results_dir = CHARACTEREVAL_ROOT / "qwen2.5-14b" / "results" / display_name
