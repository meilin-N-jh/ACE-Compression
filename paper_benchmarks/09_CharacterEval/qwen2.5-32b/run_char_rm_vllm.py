#!/usr/bin/env python3
"""Run CharacterRM evaluation (adapted from official for qwen2.5-32b)."""
...
def main():
    ...
    parser.add_argument('--display-name', type=str, default=None,
                        help='Display name for results directory (e.g., "Qwen2.5-32B-FP16")')
    ...
    model_results_dir = CHARACTEREVAL_ROOT / "qwen2.5-32b" / "results" / display_name
