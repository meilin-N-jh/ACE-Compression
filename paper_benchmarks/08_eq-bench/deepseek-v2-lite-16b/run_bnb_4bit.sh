...
# Run EQ-Bench for DeepSeek-V2-Lite-16B BNB-4bit via vLLM OpenAI API

set -euo pipefail

EQBENCH_DIR="${ARTIFACT_ROOT}/paper_benchmarks/08_eq-bench/benchmark"
CONFIG_FILE="$EQBENCH_DIR/deepseek-v2-lite-16b/config/config_bnb_4bit.cfg"
PORT="8301"
TIMESTAMP=$(date +%Y-%m-%d_%H%M%S)

RESULTS_DIR="$EQBENCH_DIR/deepseek-v2-lite-16b/results"
RUN_LOG="$EQBENCH_DIR/deepseek-v2-lite-16b/logs/eqbench_bnb_4bit_${TIMESTAMP}.log"
