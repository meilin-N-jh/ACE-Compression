...
RAW_RESULTS_PATH = os.path.join(os.environ.get('EQBENCH_OUTPUT_DIR', '.'), 'raw_results.json')
...
def process_question(question_id, q, model_path, prompt_type, model, tokenizer, results, run_index, 
	...
	COMPLETION_TOKENS = 1024  # Minimum for merged LoRA model with chain-of-thought
	if REVISE:
